package com.victor.helpdesk.helpdesk.security;
...
import com.victor.helpdesk.helpdesk.dto.CredenciaisDTO;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
  ...
  public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(cred.getEmail(),
